...
The increased number of buckets does however cause an increase in the total memory usage of the data structure, as each bucket has an overhead of 24 bytes on a 64-bit operating system.
