...
Figure XXC presents how many buckets per partition is created. This metric show
...
is very similar to the one from Figure XXAS. Again by increasing the radius the
